...
from myapp.models import TravelPost, User
...
def user_posts(username):
    ...
    travel_posts = TravelPost.query.filter_by(author=user).order_by(TravelPost.date.desc()).paginate(page=page, per_page=8) 
